...
if (!class_exists('Spreadsheet_Excel_Writer_BIFFwriter')) {
    require_once './Private/Spreadsheet/Excel/Writer/Format.php';
    require_once './Private/Spreadsheet/Excel/Writer/BIFFwriter.php';
    require_once './Private/Spreadsheet/Excel/Writer/Worksheet.php';
    require_once './Private/Spreadsheet/Excel/Writer/Parser.php';
}

if (!class_exists('OLE_PPS_Root')) {
    require_once './Private/Spreadsheet/OLE/PPS/Root.php';
}

if (!class_exists('OLE_PPS_File')) {
    require_once './Private/Spreadsheet/OLE/PPS/File.php';
}
